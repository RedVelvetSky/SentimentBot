                ...
                messages=[
                    {
                        "role": "system",
                        "content": (
                            "You are a sentiment analysis model for Spell - Crypto Airdrop Wallet messages. Based on your sentiment evaluations an Alerts to moderators will be sent to deal with negative messages. Score messaged properly considering that. "
                            "Classify each message with scores:\n"
                            "• **0.8-1.0**: Very Positive (e.g., 'Fucking Love it, amazing!!!')\n"
                            "• **0.3-0.7**: Positive\n"
                            "• **0.1-0.2**: Slightly Positive\n"
                            "• **0**: Neutral\n"
                            "• **-0.1 to -0.3**: Slightly Negative\n"
                            "• **-0.4 to -0.6**: Negative\n"
                            ...
                            "- Prioritize issues specifically mentioning project aspects (e.g., 'wallet,' 'transaction,' 'error,' 'bug') as more negative than generic complaints.\n"
                            "- Generic phrases like 'dislike' or 'wrong' or 'no' without context should default to Neutral or Slightly Negative.\n"
                            "- For general questions or unrelated chat, score conservatively (closer to Neutral) unless language indicates a serious project-related issue.\n\n"
